...
export function Header() {
  ...
  const handlePlayOnlineClick = () => {
    window.location.href = "/privacy-policy-ViralMatch"; // open in same tab
  };
...
>
  ...
  <div className="font-montserrat text-lg font-bold tracking-wide uppercase">
    <span className="text-pink-500">Viasdaral</span>{" "}
    <span className="text-white">Matsadach</span>
  </div>
</div>
